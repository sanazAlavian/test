...
class _MyAppState extends State<MyApp> {
  ...
  final String _clientId = 'demo-app';
  final String _redirectUrl = 'https://ir.2tmedia';
//  final String _issuer = 'https://idp.devscale.ir/auth/realms/2TMedia';
  final String _discoveryUrl =
         'https://idp.devscale.ir/auth/realms/2TMedia/.well-known/openid-configuration';
...
//    'api'
  ...
  AuthorizationServiceConfiguration(
      'https://idp.devscale.ir/auth/realms/2TMedia/protocol/openid-connect/auth',
      'https://idp.devscale.ir/auth/realms/2TMedia/protocol/openid-connect/token');
